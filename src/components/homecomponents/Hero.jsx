...
<section className="bg-white dark:bg-violet-600">
  <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
    <div className="mr-auto  lg:col-span-7" style={{display: 'flex', flexDirection:'column', alignItems:'start'
      ...
      <a
        ...
        className="inline-flex items-left justify-left px-5 py-3 text-base font-medium text-left text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
      >
        Get Started
      </a>
    </div>
