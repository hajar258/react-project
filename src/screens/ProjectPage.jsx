...
>
    <div className="max-w-screen-xl text-gray-500 sm:text-lg dark:text-gray-400 w-100 px-6" >
      ...
      <a
        ...
        className="inline-flex items-left justify-left px-5 py-4 text-base font-medium text-left text-gray-900  rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:hover:bg-violet-200 dark:focus:ring-gray-800"
      >
  ...
  <li className="flex items-center" style={{width:'100%'}}>
    ...
    Your challenge is to create a tool that will enable open science project creators and skilled potential contributors to identify one another and communicate.
  </li>
  <li className="flex items-center">
    ...
    Project creators will need to explain their projects and the type of collaborators (and level of expertise) they are looking for, together with the expected scope of work. Individuals looking to participate in open science projects will need to list the skills they can bring to a project and the types of projects they are seeking, and indicate when they are available to work.
  </li>
  <li className="flex items-center">
  <svg
      className="w-3.5 h-3.5 mr-2 text-green-500 dark:text-green-400 flex-shrink-0"
    ...
    Think about how your tool will enable project creators to search for collaborators based on the skills and level of expertise they’re looking for. And how will individuals search for projects to work on based on their interests?
  </li>
  ...
  <li className="flex items-center">
    ...
    2 years of experience in Reactjs, Nodejs.
  </li>
  <li className="flex items-center">
  <svg
      className="w-3.5 h-3.5 mr-2 text-green-500 dark:text-green-400 flex-shrink-0"
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6  text-left">
    ...
    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
      <div className="items-center bg-violet-600 rounded-lg shadow sm:flex dark:bg-violet-600 dark:border-violet-600">
        <a href="#">
          <img
